...
plot "rk1test.txt" using 1:(log10($3/$2)) with lines,"rk4test.txt" using 1:(log10($3/$2)) with lines,"sprk6test.txt" using 1:(log10($3/$2)) with lines
...
plot "rk1test.txt" using 1:($3/$2) with lines,"rk4test.txt" using 1:($3/$2) with lines,"sprk6test.txt" using 1:($3/$2) with lines
